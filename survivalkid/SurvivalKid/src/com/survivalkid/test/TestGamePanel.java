...
public class TestGamePanel extends SurfaceView implements
	...
	private static final String TAG = TestGamePanel.class.getSimpleName();

	private TestMainThread thread;
	private Character character;
	private Yugo yugo;

	public TestGamePanel(Context context) {
		super(context);
		...
		thread = new TestMainThread(getHolder(), this);
